...
<head>
    ...
    <meta name="msapplication-config" content="resourses/favicons/browserconfig.xml">
...
<body>
    <header>
        <nav>
            <div class="row">
                <img src="resourses/img/logo-white.png" alt="Omnifood logo" class="logo">
                <img src="resourses/img/logo.png" alt="Omnifood logo" class="logo-black">
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2 step-box">
                <img src="resourses/img/app-iPhone.png" alt="Omnifood app on iPhone" class="app-screen js--wp-2">
            </div>
            <div class="col span-1-of-2 step-box">
                ...
                <a href="#" class="btn-app"><img src="resourses/img/download-app.svg" alt="App Store button"></a>
                <a href="#" class="btn-app"><img src="resourses/img/download-app-android.png" alt="Google Play button"></a>
            </div>
        </div>
    </section>
    <section class="section-cites" id="cities">
        ...
        <div class="col span-1-of-4 box">
            <img src="resourses/img/lisbon-3.jpg" alt="Lisbon">
            <h3>Lisbon</h3>
        ...
        <div class="col span-1-of-4 box">
            <img src="resourses/img/san-francisco.jpg" alt="San Francisco">
            <h3>San Francisco</h3>
            <div class="city-feature">
                <i class="ion-ios-person icon-small"></i>
                3700+ happy eaters
        ...
        <div class="col span-1-of-4 box">
            <img src="resourses/img/berlin.jpg" alt="Berlin">
            <h3>Berlin</h3>
            <div class="city-feature">
                <i class="ion-ios-person icon-small"></i>
                2300+ happy eaters
        ...
        <div class="col span-1-of-4 box">
            <img src="resourses/img/london.jpg" alt="London">
            <h3>London</h3>
            <div class="city-feature">
                <i class="ion-ios-person icon-small"></i>
                1200+ happy eaters
    ...
    <section class="section-testimonials">
        ...
        <div class="row">
            <div class="col span-1-of-3">
                ...
                <cite> <img src="resourses/img/customer-1.jpg" alt="Picture of Alberto Duncan">Alberto Duncan</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
                <cite> <img src="resourses/img/customer-2.jpg" alt="Picture of Joana Silva">Joana Silva</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                <cite> <img src="resourses/img/customer-3.jpg" alt="Picture of Milton Chapman">Milton Chapman</cite>
                </blockquote>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li><i class="ion-ios-checkmark-empty icon-small"></i> 1 meal 10 days/monthy</li>
                            <li><i class="ion-ios-checkmark-empty icon-small"></i> Order 24/7</li>
                            <li><i class="ion-ios-checkmark-empty icon-small"></i> Access to newest creations</li>
                            <li><i class="ion-ios-checkmark-empty icon-small"></i> Free delivery</li>
                        </ul>
    ...
    <footer>
        ...
        <div class="row">
            <p>
                Copyright &copy; 2020 by Vitaliy Gosteev. All rights reserved.
            </p>
        </div>
    </footer>
